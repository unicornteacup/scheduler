...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 4. Change the student entered for the appointment.
    ...
    // 7. Wait until the element with the updated appointment is displayed.

    await waitForElement(() => getByText(appointment, "Lydia Miller-Jones"));

    // 8. Check that the DayListItem with the text "Monday" also has the same amount of spots remaining.
